...
import youngdevs.production.onlinestore.databinding.FragmentSettingsBinding
import youngdevs.production.onlinestore.presentation.viewmodel.SettingsViewModel
...
class SettingsFragment : Fragment() {
    ...
    private fun setEventListener() {
        ...
        binding.btnCart.setOnClickListener {
            // Навигируем пользователя на экран избранных событий.
            findNavController()
                .navigate(R.id.action_settingsFragment_to_cartFragment)
        }
